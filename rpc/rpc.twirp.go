...
func NewHelloWorldProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) HelloWorld {
	...
	serviceURL += baseServicePath(pathPrefix, "helloworld", "HelloWorld")
	urls := [1]string{
		serviceURL + "Hello",
	}
...
const HelloWorldPathPrefix = "/twirp/helloworld.HelloWorld/"
...
func (s *helloWorldServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "helloworld.HelloWorld" {
...
func (s *helloWorldServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "helloworld", "HelloWorld")
}
...
var twirpFileDescriptor0 = []byte{
	...
	0x49, 0x51, 0x52, 0xe1, 0xe2, 0xf0, 0x00, 0xf1, 0x82, 0x52, 0x0b, 0x85, 0x24, 0xb8, 0xd8, 0x8b,
	0x4b, 0x93, 0xb2, 0x52, 0x93, 0x4b, 0x24, 0x18, 0x15, 0x18, 0x35, 0x38, 0x83, 0x60, 0x5c, 0x25,
	0x79, 0x2e, 0x4e, 0xa8, 0xaa, 0xe2, 0x02, 0x21, 0x21, 0x2e, 0x96, 0x92, 0xd4, 0x0a, 0x98, 0x1a,
	0x30, 0xdb, 0xc8, 0x89, 0x8b, 0x0b, 0xac, 0x20, 0x1c, 0x64, 0xa8, 0x90, 0x09, 0x17, 0x2b, 0x98,
	0x27, 0x24, 0xa2, 0x87, 0xb0, 0x4a, 0x0f, 0x66, 0x8f, 0x94, 0x28, 0x16, 0xd1, 0xe2, 0x02, 0x27,
	0xae, 0x28, 0x8e, 0xa2, 0x82, 0x64, 0x7d, 0xeb, 0xa2, 0x82, 0xe4, 0x24, 0x36, 0xb0, 0x4b, 0x8d,
	0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x42, 0x90, 0xe1, 0x8d, 0xb6, 0x00, 0x00, 0x00,
}
